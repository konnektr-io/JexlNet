...
namespace JexlNet
{
    ...
    {
        public ParserStateTokenType(
            GrammarType? toState = null,
            Action<Parser, Node> handler = null
        )
        {
            ToState = toState;
            Handler = handler;
    ...
    {
        internal static Dictionary<GrammarType, ParserState> States = new Dictionary<
            GrammarType,
            ParserState
        >()
        {
            {
                GrammarType.ExpectOperand,
                new ParserState()
                {
                    TokenTypes = new Dictionary<GrammarType, ParserStateTokenType>()
                    {
                        {
                            GrammarType.Literal,
                            new ParserStateTokenType(GrammarType.ExpectBinaryOperator)
                        },
                        {
                            GrammarType.Identifier,
                            new ParserStateTokenType(GrammarType.Identifier)
                        },
                        { GrammarType.UnaryOperator, new ParserStateTokenType() },
                        {
                            GrammarType.OpenParen,
                            new ParserStateTokenType(GrammarType.SubExpression)
                        },
                        {
                            GrammarType.OpenCurl,
                            new ParserStateTokenType(
                                GrammarType.ExpectObjectKey,
                                ParserHandlers.ObjectStart
                            )
                        },
                        { GrammarType.Dot, new ParserStateTokenType(GrammarType.Traverse) },
                        {
                            ...
                            new ParserStateTokenType(
                                GrammarType.ArrayValue,
                                ParserHandlers.ArrayStart
                            )
                        }
                    }
                }
            ...
            {
                GrammarType.ExpectBinaryOperator,
                new ParserState()
                {
                    TokenTypes = new Dictionary<GrammarType, ParserStateTokenType>()
                    {
                        {
                            ...
                            new ParserStateTokenType(GrammarType.ExpectOperand)
                        },
                        ...
                        { GrammarType.Dot, new ParserStateTokenType(GrammarType.Traverse) },
                        {
                            ...
                            new ParserStateTokenType(
                                GrammarType.TernaryMid,
                                ParserHandlers.TernaryStart
                            )
                        }
                    },
                    Completable = true
                    ...
                    {
                        {
                            GrammarType.Identifier,
                            new ParserStateTokenType(
                                GrammarType.PostTransform,
                                ParserHandlers.Transform
                            )
                        }
                    }
                }
                    ...
                    {
                        {
                            GrammarType.Literal,
                            new ParserStateTokenType(
                                GrammarType.ExpectKeyValueSeperator,
                                ParserHandlers.ObjectKey
                            )
                        },
                        {
                            GrammarType.Identifier,
            ...
            },
            {
                ...
                new ParserState()
                {
                    TokenTypes = new Dictionary<GrammarType, ParserStateTokenType>()
                    {
                        {
                            GrammarType.OpenParen,
                            new ParserStateTokenType(GrammarType.ArgumentValue)
                        },
                        {
                            GrammarType.BinaryOperator,
                            new ParserStateTokenType(GrammarType.ExpectOperand)
                ...
                new ParserState()
                {
                    TokenTypes = new Dictionary<GrammarType, ParserStateTokenType>()
                    {
                        ...
                        { GrammarType.OpenBracket, new ParserStateTokenType(GrammarType.Filter) },
                        {
                            GrammarType.OpenParen,
                            new ParserStateTokenType(
                                GrammarType.ArgumentValue,
                                ParserHandlers.FunctionCall
                            )
                        },
                        { GrammarType.Pipe, new ParserStateTokenType(GrammarType.ExpectTransform) },
                        {
            ...
            {
                GrammarType.TernaryEnd,
                new ParserState() { SubHandler = ParserHandlers.TernaryEnd, Completable = true }
            },
        };
    }
}
